...
namespace Bastet{
  ...
  BlockArray blocks={{
      BlockImpl(Color(7),(OrientationMatrix){{ //O //should be yellow, but I find no portable way to output a yellow solid block character in ncurses.
      ...
      BlockImpl(Color(4),(OrientationMatrix){{ //I
	    {{//orientation 0 (initial)
		{0,1},{1,1},{2,1},{3,1}
	      }},
	      {{//orientation 1
      ...
      BlockImpl(Color(1),(OrientationMatrix){{ //Z
	    {{//orientation 0 (initial
		{1,1},{2,1},{0,0},{1,0}
	      }},
	      {{//orientation 1
      ...
      BlockImpl(Color(5),(OrientationMatrix){{ //T
	    {{//orientation 0 (initial
		{0,1},{1,1},{2,1},{1,0}
	      }},
	      {{//orientation 1
      ...
      BlockImpl(Color(6),(OrientationMatrix){{ //J
	    {{//orientation 0 (initial
		{0,1},{1,1},{2,1},{0,0}
	      }},
	      {{//orientation 1
      ...
      BlockImpl(Color(3),(OrientationMatrix){{ //S
	    {{//orientation 0 (initial
		{0,1},{1,1},{1,0},{2,0}
	      }},
	      {{//orientation 1
      ...
      BlockImpl(Color(2),(OrientationMatrix){{ //L
	    {{//orientation 0 (initial
		{0,1},{1,1},{2,1},{2,0}
	      }},
	      {{//orientation 1
