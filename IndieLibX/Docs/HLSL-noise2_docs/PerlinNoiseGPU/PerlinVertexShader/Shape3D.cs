...
namespace PerlinVertexShader
{
    ...
    public class MeshRenderer2
    {
        ...
        /// <summary>
        /// Creates a <see cref="VertexBuffer"/> filled with <see cref="stx_VertexPositionNormalTexture"/> vertices forming a box.
        /// </summary>
        ...
        public static MeshRenderer2 CreateTexturedBox(GraphicsDevice device, float width, float height, float depth)
        {
            ...
            stx_VertexPositionNormalTexture[] cubeVertices = new stx_VertexPositionNormalTexture[36];
            ...
            // Front face.
            cubeVertices[1] = new stx_VertexPositionNormalTexture(topLeftFront, frontNormal, textureTopLeft);
            cubeVertices[0] = new stx_VertexPositionNormalTexture(bottomLeftFront, frontNormal, textureBottomLeft);
            cubeVertices[2] = new stx_VertexPositionNormalTexture(topRightFront, frontNormal, textureTopRight);
            cubeVertices[4] = new stx_VertexPositionNormalTexture(bottomLeftFront, frontNormal, textureBottomLeft);
            cubeVertices[3] = new stx_VertexPositionNormalTexture(bottomRightFront, frontNormal, textureBottomRight);
            cubeVertices[5] = new stx_VertexPositionNormalTexture(topRightFront, frontNormal, textureTopRight);

            // Back face.
            cubeVertices[7] = new stx_VertexPositionNormalTexture(topLeftBack, backNormal, textureTopRight);
            cubeVertices[6] = new stx_VertexPositionNormalTexture(topRightBack, backNormal, textureTopLeft);
            cubeVertices[8] = new stx_VertexPositionNormalTexture(bottomLeftBack, backNormal, textureBottomRight);
            cubeVertices[10] = new stx_VertexPositionNormalTexture(bottomLeftBack, backNormal, textureBottomRight);
            cubeVertices[9] = new stx_VertexPositionNormalTexture(topRightBack, backNormal, textureTopLeft);
            cubeVertices[11] = new stx_VertexPositionNormalTexture(bottomRightBack, backNormal, textureBottomLeft);

            // Top face.
            cubeVertices[13] = new stx_VertexPositionNormalTexture(topLeftFront, topNormal, textureBottomLeft);
            cubeVertices[12] = new stx_VertexPositionNormalTexture(topRightBack, topNormal, textureTopRight);
            cubeVertices[14] = new stx_VertexPositionNormalTexture(topLeftBack, topNormal, textureTopLeft);
            cubeVertices[16] = new stx_VertexPositionNormalTexture(topLeftFront, topNormal, textureBottomLeft);
            cubeVertices[15] = new stx_VertexPositionNormalTexture(topRightFront, topNormal, textureBottomRight);
            cubeVertices[17] = new stx_VertexPositionNormalTexture(topRightBack, topNormal, textureTopRight);

            // Bottom face. 
            cubeVertices[19] = new stx_VertexPositionNormalTexture(bottomLeftFront, bottomNormal, textureTopLeft);
            cubeVertices[18] = new stx_VertexPositionNormalTexture(bottomLeftBack, bottomNormal, textureBottomLeft);
            cubeVertices[20] = new stx_VertexPositionNormalTexture(bottomRightBack, bottomNormal, textureBottomRight);
            cubeVertices[22] = new stx_VertexPositionNormalTexture(bottomLeftFront, bottomNormal, textureTopLeft);
            cubeVertices[21] = new stx_VertexPositionNormalTexture(bottomRightBack, bottomNormal, textureBottomRight);
            cubeVertices[23] = new stx_VertexPositionNormalTexture(bottomRightFront, bottomNormal, textureTopRight);

            // Left face.
            cubeVertices[25] = new stx_VertexPositionNormalTexture(topLeftFront, leftNormal, textureTopRight);
            cubeVertices[24] = new stx_VertexPositionNormalTexture(bottomLeftBack, leftNormal, textureBottomLeft);
            cubeVertices[26] = new stx_VertexPositionNormalTexture(bottomLeftFront, leftNormal, textureBottomRight);
            cubeVertices[28] = new stx_VertexPositionNormalTexture(topLeftBack, leftNormal, textureTopLeft);
            cubeVertices[27] = new stx_VertexPositionNormalTexture(bottomLeftBack, leftNormal, textureBottomLeft);
            cubeVertices[29] = new stx_VertexPositionNormalTexture(topLeftFront, leftNormal, textureTopRight);

            // Right face. 
            cubeVertices[31] = new stx_VertexPositionNormalTexture(topRightFront, rightNormal, textureTopLeft);
            cubeVertices[30] = new stx_VertexPositionNormalTexture(bottomRightFront, rightNormal, textureBottomLeft);
            cubeVertices[32] = new stx_VertexPositionNormalTexture(bottomRightBack, rightNormal, textureBottomRight);
            cubeVertices[34] = new stx_VertexPositionNormalTexture(topRightBack, rightNormal, textureTopRight);
            cubeVertices[33] = new stx_VertexPositionNormalTexture(topRightFront, rightNormal, textureTopLeft);
            cubeVertices[35] = new stx_VertexPositionNormalTexture(bottomRightBack, rightNormal, textureBottomRight);

            // Create the actual vertex buffer
            shape.VertexBuffer = new VertexBuffer(device, stx_VertexPositionNormalTexture.SizeInBytes * cubeVertices.Length, BufferUsage.None);
            shape.VertexBuffer.SetData<stx_VertexPositionNormalTexture>(cubeVertices);

            shape.VertexCount = 36;
            shape.TriangleCount = 12;
            shape.VertexDeclaration = new VertexDeclaration(device, stx_VertexPositionNormalTexture.VertexElements);
            shape.VertexSizeInBytes = stx_VertexPositionNormalTexture.SizeInBytes;
