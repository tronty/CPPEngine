...
usage()
{
	echo "Edit the xml-element <Renderer Value=\"GLSL1_1\" /> to eg. <Renderer Value=\"GLCG1_1\" /> to change the renderer (In the file $HOME/IndieLib_resources/Framework3/Framework3.xml)."
	echo ""
	...
	echo "Example: ./make.sh Test LNX GNUMAKE";
	echo "Example: ./make.sh NDK NDK NDK";
