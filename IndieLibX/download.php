...
if (file_exists($filename)) {
    echo "<TR><TD><A TARGET='_blank' HREF='http://tommironty.fi/".$filename."'>".$filename."</A></TD><TD>".filesize($filename)."</TD><TD>".date("F d Y H:i:s.", filemtime($filename))."</TD><TD><P>3D models loaded with assimp-5.0.1 static library. Build depends on SDL2-2.0.10. Some color related issues fixed.</P></TD><TD><P></P></TD></TR>";
}
