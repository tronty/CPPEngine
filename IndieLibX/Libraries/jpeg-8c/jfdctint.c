...
{
  INT32_JPEG_ tmp0, tmp1, tmp2, tmp3, tmp4;
  INT32_JPEG_ tmp10, tmp11, tmp12, tmp13;
  INT32_JPEG_ z1, z2;
  DCTELEM workspace[8];
  DCTELEM *dataptr;
...
{
  INT32_JPEG_ tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6;
  INT32_JPEG_ tmp10, tmp11, tmp12, tmp13, tmp14, tmp15;
  INT32_JPEG_ z1, z2;
...
{
  INT32_JPEG_ tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7;
  INT32_JPEG_ tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16;
  INT32_JPEG_ z1, z2, z3;
...
{
  INT32_JPEG_ tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7;
  INT32_JPEG_ tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17;
