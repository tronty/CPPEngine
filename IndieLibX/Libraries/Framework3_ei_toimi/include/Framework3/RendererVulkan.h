...
struct RendererVulkan : public RendererHLSLCg
{
	...
	protected:
		bool mOk;
	public:
 		virtual BufferID addBufferVrtl(const STX_BUFFER_DESC      *pDesc, const STX_SUBRESOURCE_DATA *pInitialData){IMPLEMENT;}
 		virtual ShaderID addHLSLShaderVrtl(const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const char*, unsigned int){IMPLEMENT;}
 		virtual int getSamplerIndex(ShaderID shd, const char* aName){IMPLEMENT;}
 		
 		ShaderID addGLSLShader(
const char *vsText0=0, 
//const char *gsText0=0, 
const char *fsText0=0, 
//const char *csText0=0, const char *hsText0=0, const char *dsText0=0,
const char *vsName=0, 
//const char *gsMain=0, 
const char *psName=0, 
//const char *csMain=0, const char *hsMain=0, const char *dsMain=0,
...
protected:
	...
	VArray <ShaderGLSLGL3> shadersGL;
