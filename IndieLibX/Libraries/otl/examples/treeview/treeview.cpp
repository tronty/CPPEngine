...
"../../IndieLib_resources/otldata/arbaro-xml/cactus.xml"
  ...
  return SDL_FrameWork(new TreeView(argv_[1], argv_[2], argv_[3])).run();
}
...
void TreeView::init()
{
  ...
  stem_tex = renderer->loadTexture("../../IndieLib_resources/otldata/textures/vertical_bark.jpg");
  stem_tex_n = renderer->loadTexture("../../IndieLib_resources/otldata/textures/vertical_bark_n.jpg");
  stem_tex_h = renderer->loadTexture("../../IndieLib_resources/otldata/textures/vertical_bark_h.jpg");

  branch_tex = renderer->loadTexture("../../IndieLib_resources/otldata/textures/bark.jpg");
  branch_tex_n = renderer->loadTexture("../../IndieLib_resources/otldata/textures/bark_n.jpg");
  branch_tex_h = renderer->loadTexture("../../IndieLib_resources/otldata/textures/bark_h.jpg");
  ...
  /*
  stem_tex = renderer->loadTexture("../../IndieLib_resources/otldata/textures/box.jpg");
  branch_tex = renderer->loadTexture("../../IndieLib_resources/otldata/textures/box.jpg");
  normal_tex = renderer->loadTexture("../../IndieLib_resources/otldata/textures/boxn.jpg");
  height_tex = renderer->loadTexture("../../IndieLib_resources/otldata/textures/boxh.jpg");
  */
