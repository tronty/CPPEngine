...
private:
  ...
  OTL_Texture* stem_tex;
  OTL_Texture* stem_tex_n;
  OTL_Texture* stem_tex_h;
  OTL_Texture* branch_tex;
  OTL_Texture* branch_tex_n;
  OTL_Texture* branch_tex_h;
  OTL_Texture* leaves_tex;
