...
public:
  ...
  void setupArray(OTL_Vertex* vertices, const unsigned int numvertices);//, const Tangent* tangents = 0);
  void setupVBOArray(const unsigned int vertices);
  unsigned int createVBO(OTL_Vertex* vertices, const unsigned int count);
