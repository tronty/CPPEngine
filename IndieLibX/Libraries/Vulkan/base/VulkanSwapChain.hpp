...
public:
	...
	*/
	...
	SDL_Window* g_SDL_window = SDL_CreateWindow( "SDL -Vulkan", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1024, 800, SDL_WINDOW_OPENGL );
    	SDL_GLContext g_SDL_context=SDL_GL_CreateContext(g_SDL_window);
