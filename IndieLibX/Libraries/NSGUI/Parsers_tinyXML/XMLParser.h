...
class XMLTree : public NamedObject
{
  ...
  public:
   ...
   ~XMLTree(){children.clear();}
    ...
    void setValue(const NSString& a){value=a;}
    
    const NSString& getValue(){return value;}
...
class XMLAttribute : public NamedObject
{
  protected:
    ...
    NSString value;
  public:
    XMLAttribute(NSString aName, NSString aValue) : NamedObject() // : NamedObject(aName)
    {
		name=aName;
		value=aValue;
		//CheckValue();
   ...
   ~XMLAttribute(){}
	...
	void setName( const NSString& _name ){name=_name;}
	void setValue( const NSString& _value ){value=_value;}
...
class XMLElement : public XMLTree
{
  public:
    ...
    void        addAttribute(NSString aName, NSString aValue){attributes.push_back(new XMLAttribute(aName, aValue));}
   ...
   ~XMLElement(){attributes.clear();}
    ...
    void setValue(NSString &val){value=val;}
