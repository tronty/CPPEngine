  ...
  namespace utils
  {
    ...
    class Color
    {
      ...
      public:
        ...
        Color (noise::uint8_libnoise_ r, noise::uint8_libnoise_ g, noise::uint8_libnoise_ b,
          noise::uint8_libnoise_ a):
          alpha (a), blue (b), green (g), red (r) 
        {
        }

        /// Value of the alpha (transparency) channel.
        noise::uint8_libnoise_ alpha;

        /// Value of the blue channel.
        noise::uint8_libnoise_ blue;

        /// Value of the green channel.
        noise::uint8_libnoise_ green;

        /// Value of the red channel.
        noise::uint8_libnoise_ red;
