...
{
	/* int */ double t, t2, t3, A, B, C, zeta, eta, theta, ra, dec, mean_ra, mean_dec;
	...
	if (mean_dec > (0.4 * libnova_M_PI) || mean_dec < (-0.4 * libnova_M_PI)) {
		/* close to pole */
...
{
	/* int */ double t, t2, t3, A, B, C, zeta, eta, theta, ra, dec, mean_ra, mean_dec, T, T2;
	...
	T = ((/* int */ double) (fromJD - JD2000)) / 36525.0;
	T *= 1.0 / 3600.0;
	t = ((/* int */ double) (toJD - fromJD)) / 36525.0;
	t *= 1.0 / 3600.0;
	T2 = T * T;
	t2 = t * t;
	t3 = t2 *t;
