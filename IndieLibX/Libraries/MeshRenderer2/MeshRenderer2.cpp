	...
	LOG_PRINT("Shader3DStr=%s\n", Shader3DStr.c_str());
		...
		switch(aShader)
		{
			case eColorShader:
				if(ColorShader==-1)
				{
					ColorShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/ColorShader.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eSimpleShader:
				if(SimpleShader==-1)
				{
					SimpleShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/rest.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eAmbientLighting:
				if(AmbientShader==-1)
				{
					AmbientShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/AmbientLighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eDiffuseLighting:
				if(DiffuseShader==-1)
				{
					DiffuseShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/DiffuseLighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
					DiffuseVertexDeclaration = IRenderer::GetRendererInstance()->addVertexFormat(format, elementsOf(format), DiffuseShader);
				}
				break;
            case e_Lighting:
					Shader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/_Lighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case ePhongLighting1:
				if(PhongShader1==-1)
				{
					...
					#else
					PhongShader1 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/PhongLighting1.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
					#endif
			...
			case ePhongLighting2:
				if(PhongShader2==-1)
				{
					...
					#else
					PhongShader2 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/PhongLighting2.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
					#endif
			...
			case ePhysicalBasedLighting:
				if(PhysicalBasedShader==-1)
				{
					...
					#elif 1
					PhysicalBasedShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/pbr.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
					#endif
			...
			case ePhysicalBasedLighting2:
				if(PhysicalBasedShader==-1)
				{
					PhysicalBasedShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/shd/glslsandbox.com/e#81257.1.hlsl", "main", "main", 0, eHLSL_Shader);
					PhysicalBasedVertexDeclaration = IRenderer::GetRendererInstance()->addVertexFormat(format, elementsOf(format), PhysicalBasedShader);
				}
				break;
			case eDirectionalLighting:
				...
				{
					DirectionalShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/DirectionalLighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eSpotLighting:
				if(SpotShader==-1)
				{
					SpotShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/SpotLighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eMultiLighting:
				if(MultiShader==-1)
				{
					MultiShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/MultiLighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eSimpleLighting:
				if(SimpleShader2==-1)
				{
					SimpleShader2 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/glsl_simple_lighting/simple_lighting.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
			...
			case eSnowShader:
				if(SnowShader==-1)
				{
					SnowShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/SnowAccumulation/Snow.hlsl", "RenderSceneVS_SM30", "RenderScenePS", 0, eHLSL_Shader);
					//SnowShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/SnowAccumulation/Snow.hlsl", "RenderSceneVS_NoSnow", "RenderScenePS_NoSnow, 0, eHLSL_Shader);
			...
			case eCelShader:
				if(OutlineShader==-1)
				{
					OutlineShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/NVIDIA/outline.hlsl", "main", "main", 0, eHLSL_Shader);
					OutlineVertexDeclaration = IRenderer::GetRendererInstance()->addVertexFormat(lineformat, elementsOf(lineformat), OutlineShader);
					ShadingShader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/NVIDIA/shading.hlsl", "main", "main", 0, eHLSL_Shader);
			...
			case eCelShader1:
				if(CelShader1==-1)
				{
					CelShader1 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/x/CelShader.hlsl", "main", "main", 0, eHLSL_Shader);
			...
			case eCelShader2:
				if(CelShader2==-1)
				{
					CelShader2 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/x/CelShader2.hlsl", "main", "main", 0, eHLSL_Shader);
			...
			case eCelShader3:
				if(CelShader3==-1)
				{
					//CelShader3 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/x/Toon.fx", "OutlineVertexShader", "OutlinePixelShader", 0, eHLSL_Shader);
					CelShader3 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/x/Toon.fx", "CelVertexShader", "CelPixelShader", 0, eHLSL_Shader);
			...
			case eCelShader4:
				if(CelShader4==-1)
				{
					//CelShader4 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/x/ToonColored.fx", "OutlineVertexShader", "OutlinePixelShader", 0, eHLSL_Shader);
					CelShader4 = IRenderer::GetRendererInstance()->addShaderFromFile(	"/CelShading/x/ToonColored.fx", "CelVertexShader", "CelPixelShader", 0, eHLSL_Shader);
			...
			default:
				...
				{
					////{//LOG_FNLN;}
					Shader = IRenderer::GetRendererInstance()->addShaderFromFile(	"/MeshRenderer2/rest.hlsl", mainVS, mainFS, 0, eHLSL_Shader);
					VertexDeclaration = IRenderer::GetRendererInstance()->addVertexFormat(format, elementsOf(format), Shader);
				}
				break;
		}
