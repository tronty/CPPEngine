...
GLint RendererGLSLGL_1_1__addGLSLShaderVrtl(ShaderType typ, std::vector<std::string>& sText, ShaderGLSLGL3& shaderGL1_1, GLint& infoLogPos, char* infoLog)
{
...
void RendererGLSLGL_1_1::linkGLSLShader(std::vector<std::string>& sText, ShaderGLSLGL3& shaderGL1_1)
{
	char infoLog[2048];
	GLint infoLogPos = 0;
	GLint fsResult=RendererGLSLGL_1_1__addGLSLShaderVrtl(ePixelShader, sText, shaderGL1_1, infoLogPos, infoLog);
	GLint vsResult=RendererGLSLGL_1_1__addGLSLShaderVrtl(eVertexShader, sText, shaderGL1_1, infoLogPos, infoLog);
	GLint gsResult=RendererGLSLGL_1_1__addGLSLShaderVrtl(eGeometryShader, sText, shaderGL1_1, infoLogPos, infoLog);
	GLint hsResult=RendererGLSLGL_1_1__addGLSLShaderVrtl(eHullShader, sText, shaderGL1_1, infoLogPos, infoLog);
	GLint dsResult=RendererGLSLGL_1_1__addGLSLShaderVrtl(eDomainShader, sText, shaderGL1_1, infoLogPos, infoLog);
	GLint csResult=RendererGLSLGL_1_1__addGLSLShaderVrtl(eComputeShader, sText, shaderGL1_1, infoLogPos, infoLog);
	#if 0
...
LOG_FNLN;
	...
	if (vsText.length())
	{
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:986\n");
#if 0
GL_COMPUTE_SHADER
...
LOG_FNLN;
				...
				{
LOG_FNLN;
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1024\n");
			...
			else vsResult = GL_FALSE;
			#if 0
		printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1039\n");
		if(vsResult==GL_TRUE)
			printf("vsResult=GL_TRUE\n");
		else			
			printf("vsResult=GL_FALSE\n");
			if(0){
				GLint blen = 0;	
				GLsizei slen = 0;
			...
			if (fsText.length())
			{
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1070\n");
...
LOG_FNLN;
			...
			else fsResult = GL_FALSE;
#if 0
		printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1110\n");
		if(fsResult==GL_TRUE)
			printf("fsResult=GL_TRUE\n");
		else			
			printf("fsResult=GL_FALSE\n");
...
LOG_FNLN;
			glLinkProgramARB(shaderGL1_1.program);
				...
				infoLogPos += len;
LOG_FNLN;
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1160\n");
			if (linkResult)
				{
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1163\n");
LOG_FNLN;
			GLuint currProgram =
#ifdef __APPLE__
handle_to_uint((currentShader == SHADER_NONE)? 0 : shaders[currentShader].program);
...
//stx_exit(0);
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1277\n");
			return shaders.size()-1;
				}
			}
#if 0
		...
		printf("\nfsText:\n%s\n", fsText.c_str());
#endif
		//printf("\nRendererGLSLGL_1_1::addHLSLShaderVrtl:1281\n");
			return SHADER_NONE;
		}
