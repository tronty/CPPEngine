...
void Renderer::setupArray(const OTL_Vertex* vertices, const unsigned int numvertices)//, const Tangent* tangents)
{
#if 0
  if (vlist != vertices)
  {
...
unsigned int Renderer::createVBO(const OTL_Vertex* vertices, const unsigned int count)
{
