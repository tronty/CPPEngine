...
public:
	...
	bool ImportObj(stx_3DModel *pModel, char *strFileName);

	// This is the main loading loop that gets called in ImportObj()
	int ReadObjFile(stx_3DModel *pModel);
	...
	int FillInObjectInfo(stx_3DModel *pModel);
	...
	void SetObjectMaterial(stx_3DModel *pModel, int whichObject, int materialID);
	...
	void AddMaterial(stx_3DModel *pModel, char *strName, char *strFile, 
