...
typedef void ( CALLBACK*LPCREATEVERTEXBUFFER9 )( IDirect3DDevice9* pDev, IDirect3DVertexBuffer9** ppBuffer,
                                                 UINT iSizeBytes, __DWORD__ Usage, __DWORD__ FVF, D3DPOOL Pool, void* pData,
                                                 void* pContext );
typedef void ( CALLBACK*LPCREATEINDEXBUFFER9 )( IDirect3DDevice9* pDev, IDirect3DIndexBuffer9** ppBuffer,
                                                UINT iSizeBytes, __DWORD__ Usage, D3DFORMAT ibFormat, D3DPOOL Pool,
...
public:
    ...
    HRESULT     SetFVF( LPDIRECT3DDEVICE9 pd3dDevice, __DWORD__ dwFVF );
