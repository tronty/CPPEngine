...
bool CLoadObj::ImportObj(stx_3DModel *pModel, char *strFileName)
{
	//LOG_FNLN;
...
int CLoadObj::ReadObjFile(stx_3DModel *pModel)
{
	//LOG_FNLN;
	char strLine[255]		= {0};
	char ch					= 0;
...
{
	//LOG_FNLN;
	D3DXFROMWINEVECTOR3 vNewVertex		= {0};
	D3DXFROMWINEVECTOR2 vNewTexCoord	= {0};
	char strLine[255]		= {0};
	char ch = 0;
...
int CLoadObj::FillInObjectInfo(stx_3DModel *pModel)
{
	//LOG_FNLN;
	stx_3DObject newObject;
	...
	stx_3DObject *pObject = &(pModel->pObject[pModel->numOfObjects - 1]);
...
void CLoadObj::SetObjectMaterial(stx_3DModel *pModel, int whichObject, int materialID)
{
	//LOG_FNLN;
...
void CLoadObj::AddMaterial(stx_3DModel *pModel, char *strName, char *strFile, 
									int r,			  int g,		 int b)
{
	//LOG_FNLN;
	stx_MaterialInfo newMaterial = {0};
...
D3DXFROMWINEVECTOR3 Vector(D3DXFROMWINEVECTOR3 vPoint1, D3DXFROMWINEVECTOR3 vPoint2)
{
...
D3DXFROMWINEVECTOR3 AddVector(D3DXFROMWINEVECTOR3 vVector1, D3DXFROMWINEVECTOR3 vVector2)
{
...
D3DXFROMWINEVECTOR3 DivideVectorByScaler(D3DXFROMWINEVECTOR3 vVector1, float Scaler)
{
	D3DXFROMWINEVECTOR3 vResult;							// The variable to hold the resultant vector
...
D3DXFROMWINEVECTOR3 Cross(D3DXFROMWINEVECTOR3 vVector1, D3DXFROMWINEVECTOR3 vVector2)
{
...
D3DXFROMWINEVECTOR3 Normalize(D3DXFROMWINEVECTOR3 vNormal)
{
...
void CLoadObj::ComputeNormals(stx_3DModel *pModel)
{
#if 0
	//LOG_FNLN;
