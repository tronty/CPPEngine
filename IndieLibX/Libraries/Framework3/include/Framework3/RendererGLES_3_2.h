...
#ifndef __Framework3GLES3_2_H__
#define __Framework3GLES3_2_H__

#include <Framework3/RendererGLES.h>

struct RendererGLES3_2 : public RendererGLES
{
	RendererGLES3_2(bool fullScreen=false, int argc=0, char *argv[]=0);
	virtual ~RendererGLES3_2();
	protected:
		bool mOk;
	public:
	...
	virtual Texture* GetTexture(TextureID id)
	{
		...
		virtual const char* getString(){return "GLES3_2";}
