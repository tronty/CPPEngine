...
#if 1
    	GLPROC(glVertexAttribPointerARB);
    	GLPROC(glShaderSourceARB);
    	GLPROC(glCompileShaderARB);
    	GLPROC(glLinkProgramARB);

    	GLPROC(glCreateShaderObjectARB);
    	GLPROC(glGetObjectParameterivARB);
    	GLPROC(glGetInfoLogARB);
    	GLPROC(glAttachObjectARB);
    	GLPROC(glCreateProgramObjectARB);
    	GLPROC(glDeleteObjectARB);
    	GLPROC(glUniform1fvARB);
    	GLPROC(glUniform1ivARB);
    	GLPROC(glUniform2fvARB);
    	GLPROC(glUniform2ivARB);
    	GLPROC(glUniform3fvARB);
    	GLPROC(glUniform3ivARB);
    	GLPROC(glUniform4fvARB);
    	GLPROC(glUniform4ivARB);
    	GLPROC(glUniformMatrix2fvARB);
    	GLPROC(glUniformMatrix3fvARB);
    	GLPROC(glUniformMatrix4fvARB);
#endif
...
#if 1
    	GLINIT(glVertexAttribPointerARB);
    	GLINIT(glShaderSourceARB);
    	GLINIT(glCompileShaderARB);
    	GLINIT(glLinkProgramARB);
    	GLINIT(glCreateShaderObjectARB);
    	GLINIT(glGetObjectParameterivARB);
    	GLINIT(glGetInfoLogARB);
    	GLINIT(glAttachObjectARB);
    	GLINIT(glCreateProgramObjectARB);
    	GLINIT(glDeleteObjectARB);
    	GLINIT(glUniform1fvARB);
    	GLINIT(glUniform1ivARB);
    	GLINIT(glUniform2fvARB);
    	GLINIT(glUniform2ivARB);
    	GLINIT(glUniform3fvARB);
    	GLINIT(glUniform3ivARB);
    	GLINIT(glUniform4fvARB);
    	GLINIT(glUniform4ivARB);
    	GLINIT(glUniformMatrix2fvARB);
    	GLINIT(glUniformMatrix3fvARB);
    	GLINIT(glUniformMatrix4fvARB);
#endif
#elif defined(_MSC_VER)
#if !defined(USE_GLES_SHADERS)
    	GLINIT(glActiveTextureARB);
