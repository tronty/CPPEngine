...
JNIEXPORT jboolean JNICALL Java_org_libsdl_app_SDLActivity_nativeAssets(JNIEnv* env, jclass clazz, jobject assetManager)
{
LOGI("JNI_SDLActivity_nativeAssets called1");
    g_env=env;
LOGI("JNI_SDLActivity_nativeAssets called2");
    //JNIEnv *env2 = Android_JNI_GetEnv();
LOGI("JNI_SDLActivity_nativeAssets called3");
	//(*env2)->PushLocalFrame(env2, 10);
LOGI("JNI_SDLActivity_nativeAssets called4");
AAssetManager* mgr = AAssetManager_fromJava(env, assetManager);
LOGI("JNI_SDLActivity_nativeAssets called5");
g_asset_manager=mgr;
LOGI("JNI_SDLActivity_nativeAssets called6");
    return SDL_TRUE;
}
