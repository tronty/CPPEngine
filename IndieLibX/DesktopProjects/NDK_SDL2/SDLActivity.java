...
/*
    public class SDLmainTask extends AsyncTask<Void, Void, Void>{
		@Override
...
*/
	/*
public class SDLmainIntentService extends IntentService {
    public static final String PARAM_IN_MSG = "imsg";
    public static final String PARAM_OUT_MSG = "omsg";
 
    public SDLmainIntentService() {
        super("SDLmainIntentService");
    }
  ...
  class WorkingThread extends Thread {
    @Override
    public void run() {
      Log.i(TAG, "WorkingThread run 1");
	SDLActivity.nativeSDLmain();
	Log.i(TAG, "WorkingThread run 2");
    }
  }
*/
    /**
...
/*
 private String getMemInfo() {
  ...
  //if(memoryInfo.lowMemory) Log.v(TAG, "memoryInfo: lowMemory\n");	
...
*/
	...
	Log.v(TAG, "Setting assetManager 1");
	assetManager = getAssets();
	Log.v(TAG, "Setting assetManager 2");
	nativeAssets(assetManager);

	//String mi=getMemInfo();
	//Log.v(TAG, mi);

	Log.v(TAG, "SDLmainTask().execute() 1");
	//new SDLmainTask().execute();
	/*
	Intent msgIntent = new Intent(this, SDLmainIntentService.class);
	msgIntent.putExtra(SDLmainIntentService.PARAM_IN_MSG, "strInputMsg");
	startService(msgIntent);
	*/

	//intent2 = new Intent(this, TweetService.class);
        //startService(intent2);
	//intent1 = new Intent(Intent.ACTION_SYNC, null, this, SDLmainService.class);

	//intent1 = new Intent(this, SDLmainService.class);
	...
	Log.v(TAG, "SDLmainTask().execute() 2");
    }
	...
	public static native void nativeSDLmain();
