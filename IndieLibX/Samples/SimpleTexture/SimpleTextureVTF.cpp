...
{
	shd = IRenderer::GetRendererInstance()->addShaderFromFile("/SimpleTexture/SimpleTextureVTF.hlsl", "mainVS", "mainPS");
	FormatDesc format[] =
	{
...
{
	IRenderer* r=IRenderer::GetRendererInstance("SimpleTextureVTF");
