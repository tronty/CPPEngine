...
{
	STX_FNLN;
	shd = IRenderer::GetRendererInstance()->addShaderFromFile("/www.shadertoy.com/Load_Custom_Textures.shd", "main", "main");
	STX_FNLN;
	FormatDesc format[] =
	{
...
{
	STX_FNLN;
	IRenderer* r=IRenderer::GetRendererInstance("Load_Custom_Textures");
	STX_FNLN;
