...
{
	shd = IRenderer::GetRendererInstance()->addShaderFromFile("/SimpleTexture/SimpleTextureVTF2.hlsl", "mainVS", "mainPS");
	FormatDesc format[] =
	{
...
{
	IRenderer* r=IRenderer::GetRendererInstance("RenderTargetVTF2");
