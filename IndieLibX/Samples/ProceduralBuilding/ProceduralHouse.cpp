...
int init(const char* aTitle)
{
	...
	proceduralBuilding.SetFloorCount(1);
	proceduralBuilding.SetAxiom("example", "wallwithdoor:Ry:wallwithwindow:Ry:wallwithtwowindows:Ry:wallwithwindow");
	proceduralBuilding.AddRule("wallwithdoor", "wall:door:wall");
	proceduralBuilding.AddRule("wallwithwindow", "wall:window:wall");
	proceduralBuilding.AddRule("wallwithtwowindows", "wall:window:wall:window:wall");

	proceduralBuilding.SetWallTexture("/textures/ATI_SDK/512px-brick.png");
	...
	proceduralBuilding.SetTitle("ProceduralBuilding5");
    	sb.init("Olympus", "jpg");
	return 0;
}
