...
*/
#include <Framework3/ProceduralBuilding3_2.h>

ProceduralBuilding3_2 proceduralBuilding;
...
#endif
#if 1
	proceduralBuilding.init("/ProceduralBuilding/ProceduralBuilding4.xml", "/ProceduralBuilding4.x", false);
#else
	proceduralBuilding.init("/ProceduralBuilding/ProceduralBuilding4.lua", "/ProceduralBuilding4.x", false);
#endif
...
{
	IRenderer* r=IRenderer::GetRendererInstance("ProceduralBuilding4");	
