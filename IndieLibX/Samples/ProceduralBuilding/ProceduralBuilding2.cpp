...
*/
#include <Framework3/ProceduralBuilding2.h>
...
#endif
#if 1
	proceduralBuilding.init("/ProceduralBuilding/ProceduralBuilding2.xml", "/ProceduralBuilding2.x", false);
#else
	proceduralBuilding.init("/ProceduralBuilding/ProceduralBuilding2.lua", "/ProceduralBuilding2.x", false);
#endif	
...
{
	IRenderer* r=IRenderer::GetRendererInstance("ProceduralBuilding2");	
