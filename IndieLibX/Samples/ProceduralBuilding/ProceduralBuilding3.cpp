...
*/
#include <Framework3/ProceduralBuilding3.h>

ProceduralBuilding3 proceduralBuilding;
...
#endif
#if 1
	proceduralBuilding.init("/ProceduralBuilding/ProceduralBuilding3.xml", "/ProceduralBuilding3.x", false);
#else
	proceduralBuilding.init("/ProceduralBuilding/ProceduralBuilding3.lua", "/ProceduralBuilding3.x", false);
#endif
...
{
	IRenderer* r=IRenderer::GetRendererInstance("ProceduralBuilding3");	
