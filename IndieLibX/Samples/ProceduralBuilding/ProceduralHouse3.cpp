...
int init(const char* aTitle)
{
	...
	proceduralBuilding.SetFloorCount(7);
	proceduralBuilding.SetAxiom("example", "wallwithdoor:Ry:wallwithwindows:Ry:wallwithwindows:Ry:wallwithwindows");
	proceduralBuilding.AddRule("wallwithdoor", "wall:window:wall:window:wall:window:wall:door:wall:window:wall:window:wall:window:wall");
	proceduralBuilding.AddRule("wallwithwindows", "wall:window:wall:window:wall:window:wall:window:wall:window:wall:window:wall:window:wall");

	proceduralBuilding.SetWallTexture("/textures/ATI_SDK/2048px-brick.png");
...
{
	IRenderer* r=IRenderer::GetRendererInstance("ProceduralBuilding7");	
