...
bool CParticleEmitterTokenizer::ProcessVector(CMinMax<D3DXFROMWINEVECTOR3> &v, 
                                     ...
                                     std::vector<CParticleEmitterToken>::iterator &EndIter)
{
  ...
  v.m_Min = D3DXFROMWINEVECTOR3(x.m_Min, y.m_Min, z.m_Min);
  v.m_Max = D3DXFROMWINEVECTOR3(x.m_Max, y.m_Max, z.m_Max);
  
  return(true);
}

bool CParticleEmitterTokenizer::ProcessColor(CMinMax<D3DXFROMWINECOLOR> &c, 
                                     std::vector<CParticleEmitterToken>::iterator &TokenIter,
                                     std::vector<CParticleEmitterToken>::iterator &EndIter)
{
  ...
  c.m_Min = D3DXFROMWINECOLOR(r.m_Min, g.m_Min, b.m_Min, a.m_Min);
  c.m_Max = D3DXFROMWINECOLOR(r.m_Max, g.m_Max, b.m_Max, a.m_Max);
