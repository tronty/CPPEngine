...
void CParticleEmitter::Init()
{
  ...
  SetPosRange(CMinMax<D3DXFROMWINEVECTOR3>(D3DXFROMWINEVECTOR3(0.0f,0.0f,0.0f),D3DXFROMWINEVECTOR3(0.0f,0.0f,0.0f)));
...
int CParticleEmitter::RestoreDeviceObjects( pDev)
{
  
  int hr;
  if (!pDev) return 0; // nothing to do!
  m_pd3dDevice = pDev;
