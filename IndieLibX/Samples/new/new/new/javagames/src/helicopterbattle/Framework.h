 ...
 */
 ...
 struct Framework extends Canvas {
    ...
    // Images for menu.
     TextureID  gameTitleImg;
     TextureID  menuBorderImg;
   ...
   /**
     ...
     */
     void LoadContent()
    {
            menuBorder IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/menu_border.png");
            
            skyColor IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/sky_color.jpg");
            
            gameTitle IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/helicopter_battle_title.png");
