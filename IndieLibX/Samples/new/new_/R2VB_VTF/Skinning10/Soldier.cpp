...
int  OnCreateDevice()
{
    ...
    #else
    g_pEffect10=IRenderer::GetRendererInstance()->addShaderFromFile("/new/R2VB_VTF/Skinning10/Skinning10.hlsl", "main", "main");
    if(g_pEffect10==-1) {LOG_FNLN;printf("g_pEffect10=%x\n", g_pEffect10);stx_exit(0);}
    #endif
    ...
    if(g_pSkinnedVertexLayout==-1) {LOG_FNLN;printf("g_pSkinnedVertexLayout=%x\n", g_pSkinnedVertexLayout);stx_exit(0);}
	#endif
	#if 0
...
{
	IRenderer* r=IRenderer::GetRendererInstance("Soldier");
