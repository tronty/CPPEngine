...
namespace Bastet{
  ...
  Config::Config(){
    ...
    keyMappingOpts.add_options()
      ("Down",po::value<int>()->default_value(STX_KEY_DOWN),"Down key")
      ("Left",po::value<int>()->default_value(STX_KEY_LEFT),"Left key")
      ("Right",po::value<int>()->default_value(STX_KEY_RIGHT),"Right key")
      ("RotateCW",po::value<int>()->default_value(' '),"Clockwise turn key")
      ("RotateCCW",po::value<int>()->default_value(STX_KEY_UP),"Counterclockwise turn key")
      ("Drop",po::value<int>()->default_value(STX_KEY_KP_ENTER),"Drop tetromino key")
