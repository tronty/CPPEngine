...
int init(const char* aTitle)
{
	...
	shd = IRenderer::GetRendererInstance()->addShaderFromFile("/Ashli_Viewer_1.7.0/jupiter.hlsl", "main", "main");
	FormatDesc fmt[] = { 
	...
	texture=IRenderer::GetRendererInstance()->addImageLibTexture("/Ashli_Viewer_1.7.0/gas_giant_lookup2.png", false, IRenderer::GetRendererInstance()->Getlinear());
	return 0;
}
