...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="Scene_FP16">
    <pass name="p0">
        <VertexShader profile="vs_2_0" name="SceneVS" />
	<PixelShader profile="ps_2_0" name="ScenePS">
		<arg type="bool" value="false" />
		<arg type="bool" value="false" />
	</PixelShader>
    </pass>
</technique>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="FinalPass_FP16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="FinalPass">
		<arg type="bool" value="false" />
		<arg type="bool" value="false" />
	</PixelShader>
    </pass>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="FinalPass_RGBE8">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="FinalPass">
		<arg type="bool" value="true" />
		<arg type="bool" value="false" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="FinalPass_RGB16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="FinalPass">
		<arg type="bool" value="false" />
		<arg type="bool" value="true" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="FinalPassEncoded_RGB">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="FinalPassEncoded">
		<arg type="bool" value="true" />
	</PixelShader>
    </pass>
</technique>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="FinalPassEncoded_A">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="FinalPassEncoded">
		<arg type="bool" value="false" />
	</PixelShader>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale3x3_FP16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale3x3">
		<arg type="bool" value="false" />
		<arg type="bool" value="false" />
	</PixelShader>
    </pass>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale3x3_RGBE8">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale3x3">
		<arg type="bool" value="true" />
		<arg type="bool" value="false" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale3x3_RGB16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale3x3">
		<arg type="bool" value="false" />
		<arg type="bool" value="true" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale2x2_Lum_FP16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale2x2_Lum">
		<arg type="bool" value="false" />
		<arg type="bool" value="false" />
	</PixelShader>
    </pass>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale2x2_Lum_RGBE8">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale2x2_Lum">
		<arg type="bool" value="true" />
		<arg type="bool" value="false" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale2x2_Lum_RGB16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale2x2_Lum">
		<arg type="bool" value="false" />
		<arg type="bool" value="true" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale3x3_BrightPass_FP16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale3x3_BrightPass">
		<arg type="bool" value="false" />
		<arg type="bool" value="false" />
	</PixelShader>
    </pass>
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale3x3_BrightPass_RGBE8">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale3x3_BrightPass">
		<arg type="bool" value="true" />
		<arg type="bool" value="false" />
...
// Desc: 
//-----------------------------------------------------------------------------
<technique name="DownScale3x3_BrightPass_RGB16">
    <pass name="p0">
	<PixelShader profile="ps_2_0" name="DownScale3x3_BrightPass">
		<arg type="bool" value="false" />
		<arg type="bool" value="true" />
