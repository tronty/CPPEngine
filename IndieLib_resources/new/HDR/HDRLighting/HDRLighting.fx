...
<technique name="RenderScene">
    <pass name="P0">
        <VertexShader profile="vs_2_0" name="TransformScene" />
	<PixelShader profile="ps_2_0" name="PointLight" />
    </pass>
</technique>
...
<technique name="Bloom">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="BloomPS" />
    </pass>
</technique>
...
<technique name="Star">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="StarPS" />
    </pass>
</technique>
...
//       points.
//-----------------------------------------------------------------------------
<technique name="SampleAvgLum">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="SampleLumInitial" />
    </pass>
</technique>
...
//-----------------------------------------------------------------------------
<technique name="ResampleAvgLum">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="SampleLumIterative" />
    </pass>
</technique>
...
//       the evalutation
//-----------------------------------------------------------------------------
<technique name="ResampleAvgLumExp">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="SampleLumFinal" />
    </pass>
</technique>
...
//-----------------------------------------------------------------------------
<technique name="CalculateAdaptedLum">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="CalculateAdaptedLumPS" />
    </pass>
</technique>
...
// Desc: Scale the source texture down to 1/16 scale
//-----------------------------------------------------------------------------
<technique name="DownScale4x4">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="DownScale4x4PS" />
    </pass>
</technique>
...
// Desc: Scale the source texture down to 1/4 scale
//-----------------------------------------------------------------------------
<technique name="DownScale2x2">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="DownScale2x2PS" />
    </pass>
</technique>
...
//       to the center point.
//-----------------------------------------------------------------------------
<technique name="GaussBlur5x5">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="GaussBlur5x5PS" />
    </pass>
</technique>
//-----------------------------------------------------------------------------
...
// Desc: Perform a high-pass filter on the source texture
//-----------------------------------------------------------------------------
<technique name="BrightPassFilter">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="BrightPassFilterPS" />
    </pass>
</technique>
...
//-----------------------------------------------------------------------------
<technique name="FinalScenePass">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="FinalScenePassPS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_1">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_1PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_2">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_2PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_3">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_3PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_4">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_4PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_5">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_5PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_6">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_6PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_7">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_7PS" />
    </pass>
</technique>
...
// Desc: Return the average of N input textures
//-----------------------------------------------------------------------------
<technique name="MergeTextures_8">
    <pass name="P0">
	<PixelShader profile="ps_2_0" name="MergeTextures_8PS" />
    </pass>
</technique>
</Techniques>
