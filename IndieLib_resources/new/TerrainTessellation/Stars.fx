...
<Techniques>
<technique name="StarDataTechnique">
	<pass name="DrawStars">
		<RasterizerState name="Multisampling" />
		<BlendState name="AlphaBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
		<DepthStencilState name="DisableDepthWrites" X="0" />
		<VertexShader profile="vs_5_0" name="StarDataVS" />
		<HullShader profile="hs_5_0" name="" />
		<DomainShader profile="ds_5_0" name="" />
		<GeometryShader profile="gs_5_0" name="" />
		<PixelShader profile="ps_5_0" name="StarPS" />
		<VertexFormat>
