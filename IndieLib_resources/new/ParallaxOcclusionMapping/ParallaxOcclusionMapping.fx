...
<Techniques>
<technique name="RenderSceneWithPOM">
    <pass name="P0">
       <VertexShader profile="vs_3_0" name="RenderSceneVS" />
       <FragmentShader  profile="ps_3_0" name="RenderScenePS" /> 
    </pass>
</technique>
<technique name="RenderSceneWithBumpMap">
    <pass name="P0">
       <VertexShader profile="vs_2_0" name="RenderSceneVS" />
       <FragmentShader  profile="ps_2_0" name="RenderSceneBumpMapPS" /> 
    </pass>
</technique>
<technique name="RenderSceneWithPM">
    <pass name="P0">
       <VertexShader profile="vs_2_0" name="RenderSceneVS" />
       <FragmentShader  profile="ps_2_0" name="RenderSceneParallaxMappingPS" /> 
    </pass>
</technique>
</Techniques>
