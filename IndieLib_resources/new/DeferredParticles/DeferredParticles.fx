...
<BlendState name="DeferredBlending" AlphaToCoverageEnable = "FALSE" SrcBlend = "ONE" DestBlend = "INV_SRC_ALPHA" BlendOp = "ADD" SrcBlendAlpha = "ONE" DestBlendAlpha = "INV_SRC_ALPHA" BlendOpAlpha = "ADD">
    <BlendEnable id="0" value="TRUE" />
    <BlendEnable id="1" value="TRUE" />
    <RenderTargetWriteMask id="0" value="0x0F" />
    <RenderTargetWriteMask id="1" value="0x0F" />
</BlendState>
<BlendState name="ForwardBlending" AlphaToCoverageEnable = "FALSE" SrcBlend = "SRC_ALPHA" DestBlend = "INV_SRC_ALPHA" BlendOp = "ADD" SrcBlendAlpha = "ZERO" DestBlendAlpha = "ZERO" BlendOpAlpha = "ADD" />
    <BlendEnable id="0" value="TRUE" />
    <BlendEnable id="1" value="TRUE" />
    <RenderTargetWriteMask id="0" value="0x0F" />
    <RenderTargetWriteMask id="1" value="0x0F" />
</BlendState>
<BlendState name="CompositeBlending" AlphaToCoverageEnable = "FALSE" SrcBlend = "SRC_ALPHA" DestBlend = "INV_SRC_ALPHA" BlendOp = "ADD" SrcBlendAlpha = "ZERO" DestBlendAlpha = "ZERO" BlendOpAlpha = "ADD" />
    <BlendEnable id="0" value="TRUE" />
...
<RasterizerState name="RSWireframe" FillMode = "Wireframe" />
<RasterizerState name="RSSolid" FillMode = "Solid" />
<Textures>
	<Texture sampler="Base" file="/test.bmp" dimension="2" mipmap="false" SamplerState="linear" />
</Textures>
<Techniques>
<technique name="RenderParticlesToBuffer">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="RenderParticlesVS" />
        <GeometryShader profile="gs_4_0" name="" />
        <PixelShader profile="ps_4_0" name="RenderParticlesDeferredPS" />
	<BlendState name="DeferredBlending" R="0" G="0" B="0" A="0" X="0xFFFFFFFF" />
        <DepthStencilState name="DepthRead" X="0" />
        <RasterizerState name="RSSolid" />
    </pass>
</technique>
<!--
//--------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------
-->
<technique name="RenderParticles">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="RenderParticlesVS" />
        <GeometryShader profile="gs_4_0" name="" />
        <PixelShader profile="ps_4_0" name="RenderParticlesPS" />
	<BlendState name="ForwardBlending" R="0" G="0" B="0" A="0" X="0xFFFFFFFF" />
        <DepthStencilState name="DepthRead" X=0" />
        <RasterizerState name="RSSolid" />
    </pass>
</technique>
...
//--------------------------------------------------------------------------------------
-->
<technique name="CompositeParticlesToScene">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="CompositeParticlesVS" />
        <GeometryShader profile="gs_4_0" name="" />
        <PixelShader profile="ps_4_0" name="CompositeParticlesPS" />
	<BlendState name="CompositeBlending" R="0" G="0" B="0" A="0" X="0xFFFFFFFF" />
...
<technique name="RenderMesh">
	...
	<BlendState name="DisableBlending" R="0" G="0" B="0" A="0" X="0xFFFFFFFF" />
        ...
        <!-- RasterizerState name="RSWireframe" / -->
        <RasterizerState name="RSSolid" />
    </pass>
</technique>
<technique name="RenderMeshInst">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="MeshInstVS" />
        <GeometryShader profile="gs_4_0" name="" />
        <PixelShader profile="ps_4_0" name="MeshPS" />
	<BlendState name="DisableBlending" R="0" G="0" B="0" A="0" X="0xFFFFFFFF" />
        <DepthStencilState name="EnableDepth" X="0" />
