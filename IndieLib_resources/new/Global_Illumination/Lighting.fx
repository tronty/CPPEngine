...
<technique name="Render">
	<pass name="Shadow">
		...
		<VertexShader profile="vs_4_0" name="vsshadow" />
		<GeometryShader profile="gs_4_0" name="gsShadow">
			<arg type="bool" value="false" />
		</GeometryShader>
		<PixelShader profile="ps_4_0" name="psShadow">
			<arg type="bool" value="false" />
		</PixelShader>
		<VertexFormat>
	...
	<pass name="Probe0">
		<BlendState name="blendState" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
		<DepthStencilState name="dsState" X="0" />
		<VertexShader profile="vs_4_0" name="vsprobe" />
		<GeometryShader profile="gs_4_0" name="gsprobe" />
		<PixelShader profile="ps_4_0" name="psProbe">
			<arg type="bool" value="false" />
			<arg type="bool" value="false" />
			<arg type="bool" value="false" />
		</PixelShader>
	...
	<pass name="Final0">
		<BlendState name="blendState" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
		<DepthStencilState name="dsState" X="0" />
		<VertexShader profile="vs_4_0" name="vsfinal" />
		<GeometryShader profile="gs_4_0" name="" />
		<PixelShader profile="ps_4_0" name="psFinal">
			<arg type="bool" value="false" />
			<arg type="bool" value="false" />
			<arg type="bool" value="false" />
		</PixelShader>
