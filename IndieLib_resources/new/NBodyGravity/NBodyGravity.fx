...
<technique name="RenderParticles">
    <pass name="p0">
        <VertexShader profile="vs_4_0" name="VSParticleDraw" />
        <GeometryShader profile="gs_4_0" name="GSParticleDraw" />
        <PixelShader profile="ps_4_0" name="PSParticleDraw" />
        <BlendState name="ParticleBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
...
//
<technique name="AccumulateForces">
    <pass name="p0">
        <VertexShader profile="vs_4_0" name="VSForce" />
        <GeometryShader name="" />
        <PixelShader profile="ps_4_0" name="PSForce" />        
        <BlendState name="AdditiveBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="DisableDepth" X="0" />
    </pass>
</technique>
...
<technique name="AdvanceParticles">
    <pass name="p0">
        <VertexShader profile="vs_4_0" name="VSAdvance" />
        <GeometryShader profile="gs_4_0" name="GSAdvance" />
        <PixelShader profile="ps_4_0" name="PSAdvance" />  
        <BlendState name="AdvanceBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="DisableDepth" X="0" />
	<VertexFormat>
