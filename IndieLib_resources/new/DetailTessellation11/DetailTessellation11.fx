...
<Techniques>
<technique name="NoTesselation">
    <pass name="P0">
    <VertexShader profile="vs_5_0" name="VS_NoTessellation" />
	<PixelShader profile="ps_5_0" name="BumpMapPS" />
    <HullShader profile="hs_5_0" name="HS" />
    <DomainShader profile="ds_5_0" name="DS" />
...
<technique name="Tesselation">
    <pass name="P0">
    <VertexShader profile="vs_5_0" name="VS" />
	<PixelShader profile="ps_5_0" name="BumpMapPS" />
    <HullShader profile="hs_5_0" name="HS" />
    <DomainShader profile="ds_5_0" name="DS" />
    <GeometryShader profile="gs_5_0" name="" />
