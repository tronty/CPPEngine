...
<Techniques>
<technique name="RenderGrass">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="RenderGrassVS" />
        <GeometryShader name="" />
        <PixelShader profile="ps_4_0" name="RenderGrassPS" />
        <BlendState name="QuadAlphaBlendState" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="EnableDepthWrite, 0 );
        <RasterizerState name="EnableMSAA" />
    </pass>
</technique>

//--------------------------------------------------------------------------------------
<technique name="RenderTree">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="RenderTreeVS" />
        <GeometryShader name="" />
        <PixelShader profile="ps_4_0" name="PS" />
    </pass>
</technique>
//--------------------------------------------------------------------------------------
<technique name="Render">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="VS" />
        <GeometryShader name="" />
        <PixelShader profile="ps_4_0" name="PS" />
