...
<technique name="RenderParticles">
    <pass name="p0">
        <VertexShader profile="  vs_4_0" name="VSPassThroughRain" />
        <GeometryShader profile="gs_4_0" name="GSRenderRain" />
        <PixelShader profile="   ps_4_0" name="PSRenderRain" />
        <BlendState name="CorrectBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="EnableDepthTestingOnly" X="0" />
        <RasterizerState name="CullNone" />
    </pass>
</technique>
<technique name="RenderParticlesCheap">
    <pass name="p0">
        <VertexShader profile="  vs_4_0" name="VSPassThroughRain" />
        <GeometryShader profile="gs_4_0" name="GSRenderRainCheap" />
        <PixelShader profile="   ps_4_0" name="PSRenderRainCheap" />        
        <BlendState name="CorrectBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="EnableDepthTestingOnly" X="0" />
        <RasterizerState name="CullNone" />
    </pass>
</technique>
<technique name="AdvanceParticles">
    <pass name="p0">
        <VertexShader profile="vs_4_0" name="VSAdvanceRain" />
        <GeometryShader name="gsStreamOut" />
        <PixelShader name="" />
...
<technique name="RenderScene">
    <pass name="P0">
        <VertexShader profile=" vs_4_0" name="VSScene" />
        <GeometryShader name="" />
        <PixelShader profile="ps_4_0" name="PSScene" />
        <BlendState name="NoBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="EnableDepth" X="0" />
    </pass>
</technique>
<technique name="RenderArrow">
    <pass name="P0">
        <VertexShader profile="vs_4_0" name="VSArrow" />
        <GeometryShader name="" />
        <PixelShader profile="ps_4_0" name="PSArrow" />      
        <BlendState name="NoBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="EnableDepth" X="1" />
    </pass>
</technique>
<technique name="RenderSky">
    <pass name="p0">
        <VertexShader profile="vs_4_0" name="VSSky" />
        <GeometryShader name="" />
        <PixelShader( profile="ps_4_0" name="PSSky" />
        <BlendState name="NoBlending" R="0.0" G="0.0" B="0.0" A="0.0" X="0xFFFFFFFF" />
        <DepthStencilState name="DisableDepth" X="0" />
        <RasterizerState(CullNone);
	<VertexFormat>
