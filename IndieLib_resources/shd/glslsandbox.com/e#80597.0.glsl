...
const vec3 windowColorA = vec3(1.5, 0.0, 0.0);
const vec3 windowColorB = vec3(0.5, 0.0, 0.0);
...
const vec3 signColorA = vec3(0.5, 0.0, 0.0);
const vec3 signColorB = vec3(3.0, 0.0, 0.0);
#endif
...
void main( ) {
  ...
  iTime = time;
    ...
    vec2 xy = 2.0 * xlv_TEXCOORD0 - iResolution.xy;
