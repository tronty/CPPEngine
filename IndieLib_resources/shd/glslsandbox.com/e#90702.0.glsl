...
void CalcPixelRandom()
{
    ...
    vec4 s1 = sin(time * 3.3422 + xlv_TEXCOORD0.xxxx * vec4(324.324234, 563.324234, 657.324234, 764.324234)) * 543.3423;
    vec4 s2 = sin(time * 1.3422 + xlv_TEXCOORD0.yyyy * vec4(567.324234, 435.324234, 1241424124124124 124 4 21412 412 41 4124124241 432.324234, 657.324234)) * 654.5423;
...
{
    vec2 vPixelCoord = xlv_TEXCOORD0.xy;
    #ifdef ENABLE_MONTE_CARLO
...
void main( void )
{
    ...
    vec2 vCenterPosition = (0.5 - ( xlv_TEXCOORD0.xy / resolution )) * surfaceSize + xlv_position.xy;
    ...
    #ifdef ENABLE_MONTE_CARLO                             
    vec3 cPrev = texture2D(backbuffer, xlv_TEXCOORD0.xy / resolution).xyz;
