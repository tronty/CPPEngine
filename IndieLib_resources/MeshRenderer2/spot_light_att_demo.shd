...
<!--
==============================================================================
FILE		: spot_light_att_demo.xml
AUTHOR		: JeGX
DATE		: 20.01.2006
PURPOSE		: Phong lighting in GLSL - Attenuated Spot light.
==============================================================================
-->
...
<light name="Light_01" render="TRUE" 
       type="SPOT" spot_angle="20.0" 
       display_tripod="TRUE" 
       constant_att="0.0" linear_att="0.01" quadratic_att="0.00001"  >
...
Floor.
-->
<material name="floor_mat" shader_program_name="AttSpotLightShader"
...
Torus
-->
<material name="mat_torus" shader_program_name="AttSpotLightShader" >
...
Sphere
-->
<material name="mat_sphere" shader_program_name="AttSpotLightShader" >
...
<shader_program name="AttSpotLightShader"  >
	...
	<raw_data><![CDATA[	 
		...
		//const float cos_outer_cone_angle = 0.6; // 53 degrees
		...
		void main (void)
		{
			...
			else if( cos_cur_angle > cos_outer_cone_angle )
			{
				...
				if(lambertTerm > 0.0)
				{
					final_color += gl_LightSource[0].diffuse * gl_FrontMaterial.diffuse * lambertTerm * att * falloff;	
				
					vec3 E = normalize(eyeVec);
					vec3 R = reflect(-L, N);
					float specular = pow( max(dot(R, E), 0.0), gl_FrontMaterial.shininess );
					final_color += gl_LightSource[0].specular * gl_FrontMaterial.specular * specular * att * falloff;	
				}
			}
