...
float4 vecLightDir = float4( 0.0, 1.0, 0.0, 1.0);
float4 vecEye = float4( 0.0, 0.0, 3.0, 1.0);
struct VS_INPUT
{
	float3 Pos : POSITION;
...
/*
		...
		materials.push_back(Material("Gold", glm::vec3(1.0, 0.765557f, 0.336057f), 0.1f, 1.0));
		materials.push_back(Material("Copper", glm::vec3(0.955008f, 0.637427f, 0.538163f), 0.1f, 1.0));
		materials.push_back(Material("Chromium", glm::vec3(0.549585f, 0.556114f, 0.554256f), 0.1f, 1.0));
		materials.push_back(Material("Nickel", glm::vec3(0.659777f, 0.608679f, 0.525649f), 0.1f, 1.0));
		materials.push_back(Material("Titanium", glm::vec3(0.541931f, 0.496791f, 0.449419f), 0.1f, 1.0));
		materials.push_back(Material("Cobalt", glm::vec3(0.662124f, 0.654864f, 0.633732f), 0.1f, 1.0));
		materials.push_back(Material("Platinum", glm::vec3(0.672411f, 0.637331f, 0.585456f), 0.1f, 1.0));
		// Testing materials
		materials.push_back(Material("White", glm::vec3(1.0), 0.1f, 1.0));
		materials.push_back(Material("Red", glm::vec3(1.0, 0.0, 0.0), 0.1f, 1.0));
		materials.push_back(Material("Blue", glm::vec3(0.0, 0.0, 1.0), 0.1f, 1.0));
		materials.push_back(Material("Black", glm::vec3(0.0), 0.1f, 1.0));
*/
float roughness=0.1;
float metallic=1.0;
