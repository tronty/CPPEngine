...
<!--
==============================================================================
FILE		: point_light_att_demo.xml
AUTHOR		: JeGX
DATE		: 20.01.2006
PURPOSE		: Phong lighting in GLSL - Attenuated Point light.
==============================================================================
-->
...
<light name="Light_01" render="TRUE" 
       constant_att="0.0" linear_att="0.0" quadratic_att="0.0001">
...
FLOOR.
-->
<material name="floor_mat" shader_program_name="AttPointLightShader"
...
TORUS.
-->
<material name="mat_torus" shader_program_name="AttPointLightShader" >
...
SPHERE.
-->
<material name="mat_sphere" shader_program_name="AttPointLightShader" >
...
<shader_program name="AttPointLightShader"  >
