...
<!--
==============================================================================
FILE		: point_light_demo.xml
AUTHOR		: JeGX
DATE		: 20.01.2006
PURPOSE		: Phong lighting in GLSL - Point light.
==============================================================================
-->
...
FLOOR.
-->
<material name="floor_mat" shader_program_name="PointLightShader"
...
TORUS.
-->
<material name="mat_torus" shader_program_name="PointLightShader" >
...
SPHERE.
-->
<material name="mat_sphere" shader_program_name="PointLightShader" >
...
<shader_program name="PointLightShader"  >
